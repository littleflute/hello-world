...
public:
   ...
   PointI(IN const PointI &point)
   {
       X = point.X;
       Y = point.Y;
   }

   PointI(IN const Size &size)
   {
       X = size.Width;
       Y = size.Height;
   }
   ...
   PointI operator+(IN const PointI& point) const
   {
       return PointI(X + point.X,
                    Y + point.Y);
   }
   ...
   BOOL Equals(IN const PointI& point)
   {
       return (X == point.X) && (Y == point.Y);
   }
...
public:
    ...
    VOID GetLocation(OUT PointI* point) const
    {
        point->X = X;
        point->Y = Y;
    }
    ...
    BOOL Contains(IN const PointI& pt) const
    {
        return Contains(pt.X, pt.Y);
    }
    ...
    VOID Inflate(IN const PointI& point)
    {
        Inflate(point.X, point.Y);
    }
    ...
    VOID Offset(IN const PointI& point)
    {
        Offset(point.X, point.Y);
    }
