...
// WalkLtDemo.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CWalkLtDemoApp, CWinApp)
	//{{AFX_MSG_MAP(CWalkLtDemoApp)
...
/////////////////////////////////////////////////////////////////////////////
// CWalkLtDemoApp construction

CWalkLtDemoApp::CWalkLtDemoApp()
{
...
//-----------------------------------
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CWalkLtDemoDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CWalkLtDemoView));
...
// add for Gdi+ ---------------
int CWalkLtDemoApp::ExitInstance() 
{
...
void CWalkLtDemoApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
/////////////////////////////////////////////////////////////////////////////
// CWalkLtDemoApp message handlers
