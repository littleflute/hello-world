...
public:
    ...
    SolidBrush(IN const GdiPlusColor& color)
    {
    ...
    Status GetColor(OUT GdiPlusColor* color) const
    {
        ARGB argb;
        ...
        *color = GdiPlusColor(argb);

        return lastResult;
    }

    Status SetColor(IN const GdiPlusColor& color)
    {
...
public:
    ...
    LinearGradientBrush(IN const PointF& point1,
                        ...
                        IN const GdiPlusColor& color1,
                        IN const GdiPlusColor& color2)
    {
    ...
    LinearGradientBrush(IN const PointI& point1,
                        IN const PointI& point2,
                        IN const GdiPlusColor& color1,
                        IN const GdiPlusColor& color2)
    {
        GpLineGradient *brush = NULL;
    ...
    Status SetLinearColors(IN const GdiPlusColor& color1, 
                           IN const GdiPlusColor& color2)
    {
    ...
    Status GetLinearColors(OUT GdiPlusColor* colors) const
    {
        ARGB argb[2];
        ...
        if (lastResult == Ok)
        {
            // use bitwise copy operator for GdiPlusColor copy
            colors[0] = GdiPlusColor(argb[0]);
            colors[1] = GdiPlusColor(argb[1]);
        }
...
public:
    ...
    HatchBrush(IN HatchStyle hatchStyle, 
               IN const GdiPlusColor& foreColor,
               IN const GdiPlusColor& backColor = GdiPlusColor())
    {
        GpHatch *brush = NULL;
    ...
    Status GetForegroundColor(OUT GdiPlusColor* color) const
    {
        ARGB argb;
    ...
    Status GetBackgroundColor(OUT GdiPlusColor *color) const
    {
        ARGB argb;
